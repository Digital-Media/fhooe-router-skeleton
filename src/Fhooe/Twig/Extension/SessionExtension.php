...
namespace Fhooe\Twig\Extension;
...
final class SessionExtension extends AbstractExtension
{
     ...
     * @return mixed Returns the entry from $_SESSION or null if it is not present or $_SESSION does not exist.
     */
    public function getSessionEntry(string $key): mixed
    {
        return $_SESSION[$key] ?? "nope";
    }
}
